...
dt=0.0027; % calculate time step from stability criterion
tau=dt;
r2=v.*v.*dt*dt/dx/dx;
...
for it=1:nt-2,
    ...
    [dpx_dx2, dpy_dy2] = spatial_derivatives(p2);
    Vx3 = Vx + dt * dpx_dx2;
    Vz3 = Vz + dt * dpy_dy2;
...
toc
save('figure8c_RK_non_balance_inspace.mat')
